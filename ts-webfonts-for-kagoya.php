<?php
/*
Plugin Name: TypeSquare Webfonts for カゴヤ
Version: 1.0.0
Description: カゴヤ・ジャパン株式会社が提供する各レンタルサーバーサービスでWebフォントを利用できるプラグインです。
Author: KAGOYA Japan Inc.
Author URI: https://www.kagoya.jp/
Plugin URI: https://ja.wordpress.org/plugins/kagoya-typesquare-webfonts/
...
class TypeSquare_ST {
	...
	public function load_scripts() {
		...
		wp_register_script( 'typesquare_std', "//code.typesquare.com/static/pnlkprxf3cc%253D/kagoya.js?$query", array( 'jquery' ), $version, false );
